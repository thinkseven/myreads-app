      	...
      	return (
      		<div className="list-books">
                ...
                <div className="list-books-content">
                    <div>
                      <BookShelf title="Currently Reading" books={ currentlyReadingBooks } onUpdateShelf={ this.updateShelf } />
                      <BookShelf title="Want to Read" books={ wantToReadBooks } onUpdateShelf={ this.updateShelf } />
                      <BookShelf title="Read" books={ readBooks } onUpdateShelf={ this.updateShelf } />
                    </div>
                </div>
